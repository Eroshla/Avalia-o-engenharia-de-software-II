...
# Definindo a classe LogisticaTerrestre que herda da classe Logistica
...
# Definindo a função cliente que recebe um objeto de logística como parâmetro
def cliente(logistica: Logistica):
    # Chamando o método planejar_entrega do objeto de logística e imprimindo o resultado
